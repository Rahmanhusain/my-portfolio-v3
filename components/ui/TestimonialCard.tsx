...
export default function TestimonialCard({ testimonial }: TestimonialCardProps) {
  return (
    <article className="testimonial-card glow-card border border-border rounded-2xl p-8 bg-raised flex flex-col gap-6">
      {/* Quote mark */}
      <svg
        width="32"
        height="24"
      ...
      <blockquote className="flex-1">
        <p className="text-fg leading-relaxed text-sm md:text-base">
      ...
      <footer className="flex items-center gap-3">
        {/* Avatar */}
        <div
          className="w-10 h-10 rounded-full bg-border border border-faint flex items-center justify-center text-xs font-semibold text-fg shrink-0"
          aria-hidden="true"
        >
